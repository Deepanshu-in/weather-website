...
const GENERAL_NEWS =
  "https://newsapi.org/v2/everything?q=cyclone&flood&thunderstorm&drought&earthquake&apiKey=";
...
function displayNews() {
  newsDataArr.forEach((news) => {
    ...
    col.style =
      "width: auto; height: auto; border: 1px solid rgba(0, 0, 0, .2); border-radius: 15px; margin: .4rem;";
...
async function getNews() {
  await fetch(
    "https://api.nytimes.com/svc/mostpopular/v2/viewed/1.json?api-key=ySwBmvnEPKC55fRmJZGWmCqGAurbSFC"
  )
    .then((d) => d.json())
    .then((response) => {
      ...
      .then((data) => {
        ...
        if (weatherStatus == "Clear" && get == "d") {
          ...
          app.style.backgroundImage =
            `url(./image/clear/day/clear` + randomNo1 + `.mp4)`;
          ...
          // console.log(randomNo1);
          app.style.backgroundImage =
            `url(./image/clear/night/clear` + randomNo1 + `.mp4)`;
        ...
        if (
          ...
          // console.log(randomNo1);
          app.style.backgroundImage =
            `url(./image/cloudy/mildcloudy/day/mildcloudy` +
            randomNo1 +
            `.mp4)`;
          ...
          // console.log(randomNo1);
          app.style.backgroundImage =
            `url(./image/cloudy/mildcloudy/night/mildcloudy` +
            randomNo1 +
            `.mp4)`;
        ...
        if (weatherStatus == "Clouds" && get == "d") {
          ...
          // console.log(randomNo1);
          app.style.backgroundImage =
            `url(./image/cloudy/heavycloudy/day/heavycloudy` +
            randomNo1 +
            `.mp4)`;
          ...
          // console.log(randomNo1);
          app.style.backgroundImage =
            `url(./image/cloudy/heavycloudy/night/heavycloudy` +
            randomNo1 +
            `.mp4)`;
        ...
        if (weatherStatus == "Haze" && get == "d") {
          ...
          // console.log(randomNo1);
          app.style.backgroundImage =
            `url(./image/mist/day/mist` + randomNo1 + `.mp4)`;
          ...
          // console.log(randomNo1);
          app.style.backgroundImage =
            `url(./image/mist/night/mist` + randomNo1 + `.mp4)`;
...
ScrollReveal().reveal(
  ".contact, .input-box, .subject, #third, #six, #instagram ",
  contactSubject
);
